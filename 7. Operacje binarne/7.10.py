...
# YOUR TURN
you = int(input(f'Spróbuj odgadnąć wynik wyrzuconej kostki: '))
print(f'Nie mogę nigdy wygrać chce zobaczyć jaką liczbę wylosuje komputer: {computer}') #Sprawdzam jaką liczbę wylosuje komputer
wygrywasz = (computer == you)
print(f'You won: {wygrywasz}')